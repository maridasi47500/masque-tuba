...
class S(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self._set_response(redirect=myProgram.get_redirect(),cookies=req.cookies,pic=myProgram.get_pic(),vid=myProgram.get_vid(),js=myProgram.get_js(),css=myProgram.get_css(),json=myProgram.get_json(),code422=myProgram.get_code422(),music=myProgram.get_music())
        try:
